...
import { UTILES } from './config/constants.js';
...
class ShortsPlayer {
    ...
    getUrlParams() {
        ...
        return {
            ...
            idx: searchParams.get('idx') || '100005',                   // 숏츠 또는 숏폼 컨텐츠 고유 ID
            type: searchParams.get('type') || 'shortform',             // 타입 (shortform or shorts)
            shortsSendSeq: searchParams.get('shortsSendSeq') || '0'     // UMS Send 시퀸스
        };
    }
    ...
    init() {
        ...
        if (closeButton) {
            const shouldShowButton = !UTILES.IS_MOBILE && this.urlParams.closeButtonYn === 'Y';
