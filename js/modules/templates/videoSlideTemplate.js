...
export const createVideoSlide = (index, videoData) => `
    <div class="swiper-slide" role="group">
        ...
        <div class="content-layout ${!videoData.contentTop && videoData.contentMid ? 'mid-title' : ''}">
            <h1 class="short-title" style="${videoData.contentTopFont || ''}" ${!videoData.contentTop ? 'style="display: none;"' : ''}>${videoData.contentTop || ''}</h1>
            <h1 class="short-title" style="${videoData.contentMidFont || ''}" ${!videoData.contentMid ? 'style="display: none;"' : ''}>${videoData.contentMid || ''}</h1>
            <div class="short-content" style="${videoData.contentFont || ''}">
