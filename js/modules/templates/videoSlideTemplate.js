...
export const createVideoSlide = (index, videoData) => `
    <div class="swiper-slide" role="group">
        <div class="video-wrapper">
            <img src="${videoData.mediaList[0].serverUrl}${videoData.mediaList[0].thumbnailPath}" class="video-thumbnail" id="thumbnail-${index}" style="display: none;">
            <div class="loading-spinner" id="loading-${index}" style="display: none;"></div>
            <video
                class="plyr"
        ...
        <div class="controls">
            <div class="control-icon like-button ${videoData.liked ? 'active' : ''}" data-index="${index}">
                <span></span>
